...
const fixedParams = [
    // params that are important to be kept in the url, like user info
    "first_name"
]
...
const router = async () => {
    ...
    const routes = [
        ...
        { path: "create_name_card", component: "create_name_card" },
    ]
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.body.addEventListener('click', (e) => {
        ...
        // verificar se é .toggle ou seus filhos
        if(e.target.matches('.toggle')) {
            ...
            e.target.parentElement.querySelector('input').checked = !e.target.parentElement.querySelector('input').checked
